...
from app.modulos.docentes.aplicacion.servicios import DocenteService
from app.modulos.docentes.presentacion.esquemas import RegistroDocenteSchema, ActualizarDocenteSchema
