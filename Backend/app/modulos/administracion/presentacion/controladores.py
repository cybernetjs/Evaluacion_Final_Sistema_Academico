...
from app import db
from app.dominio.modelos.academico.facultad import Facultad
...
def obtener_configuracion_ciclo():
    from app.compartido.utilidades.ciclo_academico import obtener_configuracion_activa, ESTADOS_CICLO
