...
from app.modulos.cursos.aplicacion.servicios import CursosService
from app.modulos.cursos.presentacion.esquemas import RegistroCursoSchema, ActualizarCursoSchema
