...
from app.modulos.ofertas_academicas.aplicacion.servicios import OfertaAcademicaService
from app.modulos.ofertas_academicas.presentacion.esquemas import CrearOfertaAcademicaSchema, ActualizarOfertaAcademicaSchema
